...
const SocialLogin = () => {
  const dispatch = useDispatch<AppDispatch>(); // টাইপড useDispatch ব্যবহার করুন
    ...
    return (
        ...
        <button  onClick={() => dispatch(loginWithGoogle())}  className="bg-white border border-gray-300 flex items-center justify-center gap-x-3 text-sm sm:text-base rounded-lg hover:bg-gray-100 duration-300 transition-colors px-8 py-2.5">
