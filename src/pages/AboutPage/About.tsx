  ...
  return (
    <div className=" md:px-14 lg:px-20 md:mt-10 lg:mt-16">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-16 ">
        <div>
          <img src={aboutCover} alt="" className="w-full md:w-[600px] h-72 md:h-[400px]"/>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-5 gap-5 md:gap-0 md:mt-0 px-4 md:px-0">
        <img src={img3} alt="" className="md:mt-10 lg:-mt-12 md:-ml-0 lg:-ml-4 md:w-[300px] lg:w-auto"/>
        ...
        <img src={img4} alt="" className="md:ml-36 lg:ml-4 w-full md:w-full lg:w-[315px] h-[221px] md:mt-6 lg:mt-7" />
      </div>
