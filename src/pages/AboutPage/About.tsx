  ...
  return (
    <div className=" md:px-14 lg:px-20 md:mt-10 lg:mt-16">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-16 ">
        <div>
          <img src={aboutCover} alt="" className="w-full md:w-[550px] lg:w-[600px] h-72 md:h-[450px] lg:h-[400px]" />
        </div>
      ...
      <div className="mt-7 md:mt-10 lg:mt-16 px-4 md:px-0">
        <p className="font-montserrat font-bold text-xl md:text-4xl">We provide best solution for <br /> your business</p>
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-5 md:gap-6 lg:gap-9 mt-14 px-4 md:px-0">
        <img src={img1} alt="" className="md:w-[300px] lg:w-[422px] md:h-[200px] lg:h-[259px]" />
        <img src={img2} alt="" className="md:w-[350px] lg:w-[541px] md:h-[200px] lg:h-[345px]" />
      </div>

      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-5 gap-5 md:gap-0 md:mt-0 px-4 md:px-0">
        <img src={img3} alt="" className="md:mt-10 lg:-mt-12 md:-ml-0 lg:-ml-4 w-full md:w-[320px] lg:w-[800px]" />
        <div className="md:w-[330px] lg:w-[480px] md:h-[228px] lg:h-[221px] bg-[#FF0000] rounded-2xl md:ml-2 lg:ml-6 md:mt-10 lg:mt-7">
          <p className="text-white text-4xl md:text-4xl lg:text-5xl font-semibold flex text-center items-center h-[230px]">Your digital billing solution is here</p>
        </div>
        <img src={img4} alt="" className="md:ml-36 lg:ml-24 w-full md:w-full lg:w-[370px] h-[221px] md:mt-6 lg:mt-7" />
      </div>
