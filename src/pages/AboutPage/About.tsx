    ...
    <>
      ...
      <div className="container mx-auto pb-24 px-2 md:px-4 lg:px-6">
        ...
        <section className="py-12">
          <SectionTitle
            title="Streamlining Financial Clarity for Business Growth"
            intro="Learn about us"
            content="ABOUT US"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div
              className="items-center justify-center lg:mt-0 h-96 sm:h-80 lg:h-96 xl:h-112 2xl:h-128"
            ...
            <div
              className="flex-col space-y-4 justify-center p-6 text-center rounded-sm -mt-24 md:mt-10 lg:max-w-md xl:max-w-lg lg:text-left"
              data-aos="zoom-in-down"
            >
              <h2>Who are we?</h2>
              <p className="leading-8 text-justify">
                ...
                regulations. This level of financial clarity and control can
                drive more strategic decision-making and ultimately contribute
        ...
        <section className="dark:bg-gray-100 dark:text-gray-800 rounded-2xl">
          <div className="container px-6 py-12 mx-auto">
            ...
            />
            <div
              className=" w-full mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left"
              data-aos="fade-up"
              data-aos-anchor-placement="top-bottom"
            >
              <p className="dark:text-gray-600 text-center w-3/4 mx-auto">
                We're proposing to build a web-based platform, "RevBoost,"
                designed to help your business streamline and optimize its
                revenue generation processes. The platform will be developed
                using Next.js and TypeScript, two modern technologies known for
              ...
              <div className="p-6 xl:col-span-5">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="grid content-center gap-4">
                    ...
                    >
                      <p>
                        By reducing the risk of errors and potential fines,
                        Aurora provides peace of mind to business owners,
                        knowing that their tax filings are accurate and
                        up-to-date.
                      </p>
                      <div className="flex items-center mt-4 space-x-4">
                        <img
                  ...
                  >
                    <div className="p-6 rounded shadow-md dark:bg-gray-50">
                      <p>
                        This level of financial clarity and control can drive
                        more strategic decision-making and ultimately contribute
                        to the sustainable growth of the business.
                      </p>
                      <div className="flex items-center mt-4 space-x-4">
                        <img
            ...
            <div className="grid gap-4 mx-4 sm:grid-cols-12">
              ...
              <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-300">
                  <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-deepColor">
                    ...
                    <p className="mt-3">
                      ...
                      everything from daily financial tracking to complex tax
                      and VAT compliance.
                    </p>
                  </div>
                  <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-deepColor">
                    ...
                    <p className="mt-3">
                      RevBoost Solutions empowers businesses to track and
                      analyze their revenue growth effortlessly.
                    </p>
                  </div>
                  <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-deepColor">
                    <h3 className="text-xl font-semibold tracking-wide">
        ...
        <section>
          ...
          />
          <div
            className="container px-6 py-16 mx-auto shadow-lg rounded-2xl bg-gray-100"
            data-aos="zoom-in"
          >
              ...
              <div className="w-full lg:w-1/2">
                <div className="lg:max-w-lg space-y-4">
                  <h2 className="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">
                    {" "}
                    <span className="text-deepColor ">
                      With knowledge, skills <br />
                      and hard work
                    </span>
                  </h2>

                  <p className="mt-3 text-gray-600 dark:text-gray-400 leading-8 text-justify">
                    At Revboost, we believe that sustainable growth is achieved
                    through informed financial management, practical skills, and
                    dedicated effort. Our platform offers businesses the tools
                    they need to streamline revenue tracking, improve financial
                    clarity, and support strategic decision-making. By
                    integrating automation and real-time insights, Revboost
                    empowers companies to focus on growth with confidence.
                  </p>
                  ...
                  <p className="mt-3 text-gray-600 dark:text-gray-400 leading-8 text-justify">
                    Revboost is designed to optimize and simplify your
                    business's revenue generation journey. Our advanced Company
                    Revenue Generation Platform includes essential features such
                    as lead management, sales tracking, and revenue analytics.
                    Using behavioral analytics, Revboost enables precise
                    customer segmentation, enhancing targeted revenue strategies
                    and opening the door to more effective and efficient revenue
                    growth.
                  </p>
                  <Link to={`/pricing`}>
