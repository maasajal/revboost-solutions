...
const Contact = () => {
  return (
    ...
    <div className="mt-10 inter font-medium text-[20px] text-[#000000]">
        <h1 className="inter font-extrabold text-3xl text-center">Let’s Start a Conversation</h1>
        ...
        <form className="mt-10 mb-5">
            <div className="mx-auto grid grid-cols-1 lg:flex lg:justify-between w-[80%]">
               ...
               <label>Company Name</label> <br />
                ...
                <input className="border border-black w-full h-[150px]" type="text" />

                <button className="border text-white bg-[#FF0000] h-[40px] w-[120px] mt-4 rounded-lg">Send</button>
               </section>
